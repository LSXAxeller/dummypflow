    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ActionMenuHotkey", "CreatedAtUtc", "LaunchAtLogin", "SmartPasteActionId", "SmartPasteHotkey", "Theme", "UpdatedAtUtc" },
                values: new object[] { 1, "Ctrl+J", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, null, "Ctrl+Shift+V", "System", null });

            migrationBuilder.InsertData(
                table: "ProviderSettings",
                columns: new[] { "Id", "CreatedAtUtc", "FallbackServiceType", "LocalCpuCores", "LocalModelContextSize", "LocalModelLoadOnStartup", "LocalModelMaxTokens", "LocalModelMemoryMap", "LocalModelMemorylock", "LocalModelPath", "LocalModelTemperature", "PreferGpu", "PrimaryServiceType", "UpdatedAtUtc" },
                values: new object[] { 1, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "None", 4, 4096, false, 2048, true, false, "", 0.7f, true, "Cloud", null });
